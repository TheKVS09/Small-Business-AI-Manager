...
- Questions about website analytics, conversion, acquisition,
  product interest, marketing performance, or customer email
  outreach should be delegated to the Marketing Agent.
...
Only call another tool when its information is necessary
